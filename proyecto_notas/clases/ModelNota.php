...
class ModelNota extends Model{
    ...
    function obtenUltimoID($id_propietario){
        $gestor = new GestorNota();
        return $gestor->getUltimoID($id_propietario);
    }
...
/* ****************** NOTA LISTA ************************** */
    ...
    function insertNotaLista(NotaLista $notalista){
        $gestor = new GestorNotaLista();
    ...
    function getListPaginado($id_propietario, $pc){
        $gestor = new GestorNota();
        return $gestor->getPage($pc->getPage(), $id_propietario);
    }
