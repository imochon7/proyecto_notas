...
create table nota(
    ...
    color enum('amarillo', 'azul', 'verde', 'rosa') not null default 'privado',
    ...
    constraint fk_idusuario foreign key(id_propietario) references usuario (id)
) engine=innodb default charset=utf8 collate=utf8_unicode_ci;
...
create table usuario_autorizado (
    ...
    constraint fk_nota_autorizado foreign key (idnota) references nota (id),
    constraint fk_usuario_autorizado foreign key (id_usuario_autorizado) references usuario (id)
) engine=innodb default charset=utf8 collate=utf8_unicode_ci;
...
create table notalista (
    ...
    idnota int not null,
    texto varchar(500),
    constraint fk_notalista foreign key (idnota) references nota (id)
) engine=innodb default charset=utf8 collate=utf8_unicode_ci;
...
create table notaimagen(
    ...
    path varchar(256),
    tipo varchar(15),
    constraint fk_notaimagen foreign key (idnota) references nota (id)
) engine=innodb default charset=utf8 collate=utf8_unicode_ci;